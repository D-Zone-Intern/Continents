...
public class deserts extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init() {
        ...
        photoView.setImageResource(R.drawable.desertthar);
